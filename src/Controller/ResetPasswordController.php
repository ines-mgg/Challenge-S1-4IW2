...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(SessionInterface $session, Request $request, UserPasswordHasherInterface $passwordHasher, TranslatorInterface $translator, string $token = null): Response
    {
        if ($token) {
        ...
        if ($form->isSubmitted()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->render('reset_password/password_changed_success.twig', []);
            } else {
                $errors = [];
                foreach ($form->getErrors(true) as $error) {
                    $errors[]["message"] = $error->getMessage();
